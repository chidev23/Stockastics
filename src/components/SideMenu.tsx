  ...
  return (
    <View className="absolute left-0 right-0 top-0 bottom-0 z-50 flex-row">
      <View className="h-full w-[82%] max-w-[340px] bg-white px-5 pb-8 pt-14 shadow-2xl">
        ...
        <View className="mt-auto rounded-2xl bg-slate-50 p-4"><Text className="text-xs font-bold text-slate-500">STOCKASTICS</Text><Text className="mt-1 text-xs leading-5 text-slate-400">Market intelligence and independent BUY signals.</Text></View>
      </View>
