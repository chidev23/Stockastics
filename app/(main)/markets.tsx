...
export default function MarketsScreen() {
  ...
  return <SafeAreaView className="flex-1 bg-slate-50" edges={['top']}>
    <View className="px-5 pt-4"><Text className="text-2xl font-extrabold text-slate-900">{modeLabel ? `${modeLabel} Markets` : 'Markets'}</Text><Text className="mt-1 text-sm text-slate-500">{modeLabel ? `Only stocks explicitly classified as ${modeLabel} by the screening source are shown.` : 'Explore stocks and market data by country.'}</Text>
