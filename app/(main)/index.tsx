...
const quickActions = [
  { label: 'Retail', icon: 'trending-up-outline' as const, route: '/(main)/signals' },
  ...
  { label: 'Sentiment', icon: 'pulse-outline' as const, route: '/(main)/sentiment' },
];
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerClassName="px-5 pb-8 pt-4">
        <View className="flex-row items-center justify-between">
          ...
          <View className="flex-1 px-4">
            <Text className="text-center text-sm font-extrabold tracking-[2px] text-blue-700">STOCKASTICS</Text>
          </View>
        ...
        <View className="mt-6">
          <Text className="text-sm font-medium text-slate-500">Good morning</Text>
          <Text className="mt-1 text-2xl font-extrabold text-slate-900">{firstName}</Text>
          <Text className="mt-1 text-sm text-slate-500">Here is your market intelligence for today.</Text>
        </View>
