...
export default function EducationScreen() {
  return <InfoPage title="Education" icon="school-outline" intro="Build a stronger understanding of markets, investing and the information STOCKASTICS provides." sections={[
